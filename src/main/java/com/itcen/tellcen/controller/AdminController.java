...
public class AdminController {
	...
	public String member(PagingVO vo, Model model, @RequestParam(value = "nowPage", required = false) String nowPage,
		...
		int total = adminService.countNumber();
	 ...
	 * "admin/memberOrder"; }
	 * 
	 * @GetMapping("/member/delete") public String memberDelList(PagingVO vo, Model
	 * model, @RequestParam(value = "nowPage", required = false) String nowPage,
	 * 
	 * @RequestParam(value = "cntPerPage", required = false) String cntPerPage) {
	 * int total = memberService.countDelNumber(); if (nowPage == null && cntPerPage
	 * == null) { nowPage = "1"; cntPerPage = "10"; } else if (nowPage == null) {
	 * nowPage = "1"; } else if (cntPerPage == null) { cntPerPage = "10"; }
	 * 
