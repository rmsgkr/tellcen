...
<ul class="links" id="sidebar">
	<li><a href="/tellcen/complaint/complaintInfo"
		class="button large fit">민원이란?</a></li>
	<li></li>
	<li><a href="/tellcen/complaint/complaintWrite"
		class="button large fit">민원신청</a></li>
	<li><a href="/tellcen/complaint/complaintList"
		class="button large fit">민원목록</a></li>
</ul>
<!-- Main -->
		...
		<div class="inner">
			...
			<ul class="pagination" style="text-align: center;">
				<c:if test="${paging.startPage != 1 }">
					<li><a
						href="/tellcen/complaint/complaintList?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}"
				...
				<c:forEach begin="${paging.startPage }" end="${paging.endPage }"
					...
					<c:choose>
						...
						<c:when test="${p != paging.nowPage }">
							<li><a
								href="/tellcen/complaint/complaintList?nowPage=${p }&cntPerPage=${paging.cntPerPage}"
								class="page">${p }</a></li>
						</c:when>
					</c:choose>
				</c:forEach>
				...
				<c:if test="${paging.endPage != paging.lastPage}">
					<li><a
						href="/tellcen/complaint/complaintList?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}"
