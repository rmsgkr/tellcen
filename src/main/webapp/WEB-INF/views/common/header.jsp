	...
	<div id="wrapper">
		...
		<nav id="menu">
			<ul class="actions stacked">
				...
				<li><a href="/tellcen/inquiry/inquiryWrite" class="button fit">오류·이용 문의</a></li>
				<li><a href="/tellcen/notice/noticeList" class="button fit">공지사항</a></li>
			<!-- 일반 회원 로그인 시 -->
			<c:if test="${member != null && member.author != 1}">
				<li><a href="/tellcen/mypage" class="button fit">마이페이지</a></li>
			</c:if>
			<!-- 관리자 로그인 시 -->
