		...
		<div class="inner">
			...
			<div class="box">
				...
				<div class="row">
					<div class="col-6 col-12-small">
						<button type="button" class="button fit"
							onclick="window.location.href='<%=request.getContextPath()%>/admin/complaint">전체
							민원보기</button>
					</div>
					<div class="col-6 col-12-small">
						<button type="button" class="button fit"
							onclick="window.location.href='<%=request.getContextPath()%>/admin/complaintStatus/0'">진행중인
							민원보기</button>
					</div>
				</div>
				<hr>
				<div class="row">
					<div class="col-6 col-12-small">
						<button type="button" class="button fit"
							onclick="window.location.href='<%=request.getContextPath()%>/admin/complaintStatus/1'">답변완료
							민원보기</button>
					</div>
					<div class="col-6 col-12-small">
						<button type="button" class="button fit"
							onclick="window.location.href='<%=request.getContextPath()%>/admin/complaintStatus/2'">미승인(삭제)
							민원보기</button>
					</div>
				</div>
			</div>
			...
			<ul class="pagination" style="text-align: center;">
				<c:if test="${paging.startPage != 1 }">
					<li><a
						href="/tellcen/admin/complaint?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}"
				...
				<c:forEach begin="${paging.startPage }" end="${paging.endPage }"
					...
					<c:choose>
						...
						<c:when test="${p != paging.nowPage }">
							<li><a
								href="/tellcen/admin/complaint?nowPage=${p }&cntPerPage=${paging.cntPerPage}"
								class="page">${p }</a></li>
						</c:when>
					</c:choose>
				</c:forEach>
				...
				<c:if test="${paging.endPage != paging.lastPage}">
					<li><a
						href="/tellcen/admin/complaint?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}"
