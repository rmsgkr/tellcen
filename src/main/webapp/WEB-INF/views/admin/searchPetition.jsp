		...
		<div class="inner">
			...
			<ul class="pagination" style="text-align: center;">
				<c:if test="${paging.startPage != 1 }">
					<li><a
						href="/tellcen/searchPetition?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}&petitionTitle=${paging.petitionTitle}&petitionArea=${paging.petitionArea}&petitionField=${paging.petitionField}"
				...
				<c:if test="${paging.endPage != paging.lastPage}">
					<li><a
						href="/tellcen/searchPetition?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}&petitionTitle=${paging.petitionTitle}&petitionArea=${paging.petitionArea}&petitionField=${paging.petitionField}"
