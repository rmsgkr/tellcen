...
<div id="main" class="alt">
	...
	<section id="one">
		<div class="inner">
			...
			<!-- 검색기능 -->
			<form id="formSearch" method="get" action="searchComplaint" class="searchForm">
				<div class="box">
					<div class="row">
					...
					<tbody>
						...
						<c:forEach items="${complaint }" var="list">
							<tr>
								...
								<td><button class="button " onclick="window.location.href='<%=request.getContextPath()%>/admin/complaint/${list.complaintNo}/answer'">답변</button>
								<button class="button " onclick="window.location.href='<%=request.getContextPath()%>/admin/complaint/${list.complaintNo}/delete'">삭제</button></td>
								</c:if>
			...
			<ul class="pagination" style="text-align: center;">
				<c:if test="${paging.startPage != 1 }">
					<li><a
						href="/tellcen/admin/searchComplaint?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}&complaintTitle=${paging.complaintTitle}&complaintOrganization=${paging.complaintOrganization}&complaintOrganizationDetail=${paging.complaintOrganizationDetail}&complaintSdate=${paging.complaintSdate}&complaintEdate=${paging.complaintEdate}"
				...
				<c:forEach begin="${paging.startPage }" end="${paging.endPage }"
					...
					<c:choose>
						...
						<c:when test="${p != paging.nowPage }">
							<li><a
								href="/tellcen/admin/searchComplaint?nowPage=${p }&cntPerPage=${paging.cntPerPage}&complaintTitle=${paging.complaintTitle}&complaintOrganization=${paging.complaintOrganization}&complaintOrganizationDetail=${paging.complaintOrganizationDetail}&complaintSdate=${paging.complaintSdate}&complaintEdate=${paging.complaintEdate}"
								class="page">${p }</a></li>
						</c:when>
					</c:choose>
				</c:forEach>
