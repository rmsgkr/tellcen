		...
		<div class="inner">
			...
			<ul class="pagination" style="text-align: center;">
				<c:if test="${paging.startPage != 1 }">
					<li><a
						href="/tellcen/admin/inquiry?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}"
				...
				<c:forEach begin="${paging.startPage }" end="${paging.endPage }"
					...
					<c:choose>
						...
						<c:when test="${p != paging.nowPage }">
							<li><a
								href="/tellcen/admin/inquiry?nowPage=${p }&cntPerPage=${paging.cntPerPage}"
								class="page">${p }</a></li>
						</c:when>
					</c:choose>
				</c:forEach>
				...
				<c:if test="${paging.endPage != paging.lastPage}">
					<li><a
						href="/tellcen/admin/inquiry?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}"
