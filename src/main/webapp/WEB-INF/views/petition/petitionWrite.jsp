	...
	<section id="one">
		<div class="inner">
			...
			<div class="box">
				...
				<p>
					자극적이고 혐오스러운 내용, 비속어, 폭력적 내용, 특정 대상을 비하하거나 차별을 조장하는 내용, 개인정보 유출을 비롯해
					타인의 권리를 침해하는 내용, 반복되는 내용 등은 제재될 수 있습니다. <br> <br>청원기간은
					30일 입니다.<br> <br>
				<h4 style="color: red">청원 작성시 주의사항</h4>
				한번 작성된 청원은 수정 및 삭제가 불가능합니다. <br>최초 청원취지와 다른 내용으로 변경되는 것을 방지하여
				청원참여자의 의견을 보호하기 위한 조치이니 신중하게 작성하여 주시기 바랍니다. <br> <br>
				<h4 style="color: skyblue">청원 요건에 해당되지 않는 사항</h4>
				1. 국가기관이나 지방자치단체 등 특정 기관·단체를 근거없이 비난하거나 모독하는 사항 <br>2.
				감사·수사·재판·행정심판·조정·중재 등 다른 법령에 의한 조사· 불복 또는 구제절차가 진행중인 사항 <br>3.
				욕설, 비속어 등 폭력적이고 선정적인 내용 <br>4. 허위사실이나 타인의 명예를 훼손하는 내용 <br>5.
				정치적 목적이 있거나 영리목적의 상업적인 내용 <br>6. 사인간의 권리관계 또는 개인의 사생활에 관한 사항 <br>7.
				동일 이용자가 동일한 내용의 청원서를 2회 이상 제출한 경우 나중에 제출된 것 <br>8. 그밖에 공익을
				저해하거나 법령에 위배되는 등 게시판 운영 취지에 맞지 아니하는 게시물 등
			</div>
			<form method="post" class="petitionWrite" name="writeForm"
				action="petitionWrite">
				<div class="fields">
					...
					<div class="field">
						<h3>청원내용</h3>
						<textarea name="petitionContent" id="petitionContent" rows="6"
							placeholder="청원 내용을 입력하세요."></textarea>
					</div>
				</div>
			</form>
